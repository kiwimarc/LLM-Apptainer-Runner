...
MODEL_NAME = "MedGemma 4B (SMALL, multimodal)"
MODEL_FILE = "medgemma-4b.sif"
MODEL_PATH = os.environ.get("MODEL_PATH", "/opt/models/medgemma-4b-it")
HAS_IMAGES = True
